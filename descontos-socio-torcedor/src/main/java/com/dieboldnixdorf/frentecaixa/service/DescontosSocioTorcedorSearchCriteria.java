...
/**
 * The Class DescontosSocioTorcedorSearchCriteria.
 */
public class DescontosSocioTorcedorSearchCriteria implements Serializable {
	...
	/**
	 * Instantiates a new descontos socio torcedor search criteria.
	 */
	public DescontosSocioTorcedorSearchCriteria() {
	}
	 ...
	 */
	public DescontosSocioTorcedorSearchCriteria(final String codigoLoja, final LocalDate dataExtracao, final Integer paginaInicial, final Integer paginaFinal) {
