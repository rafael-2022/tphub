...
/**
 * The Class TotalPisCofinsPdvSearchCriteria.
 */
public class TotalPisCofinsPdvSearchCriteria implements Serializable {
	...
	/**
	 * Instantiates a new total Pis/Cofins PDV search criteria.
	 */
	public TotalPisCofinsPdvSearchCriteria() {
	}
	 ...
	 */
	public TotalPisCofinsPdvSearchCriteria(final String codigoLoja, final LocalDate dataExtracao, final Integer paginaInicial, final Integer paginaFinal) {
