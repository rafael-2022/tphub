...
public class HibernateInterceptor extends EmptyInterceptor {
	...
	public String onPrepareStatement(final String sql) {
        ...
        prepedStatement = prepedStatement.replaceAll("ejmedia", getEsquemaVendas().concat(".").concat("ejmedia"));        
        //prepedStatement = prepedStatement.replaceAll("pdvlocal", getStoreIpTPLinux().concat(".").concat("pdvlocal"));
