...
/**
 * The Class DiariasConsolidadasSearchCriteria.
 */
public class DiariasConsolidadasSearchCriteria implements Serializable {
	...
	/**
	 * Instantiates a new diarias consolidadas search criteria.
	 */
	public DiariasConsolidadasSearchCriteria() {
	}
	 ...
	 */
	public DiariasConsolidadasSearchCriteria(final String codigoLoja, final LocalDate dataExtracao, final Integer paginaInicial, final Integer paginaFinal) {
