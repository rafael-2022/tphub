...
/**
 * The Class TransacoesECFAliquotaSearchCriteria.
 */
public class TransacoesECFAliquotaSearchCriteria implements Serializable {
	...
	/**
	 * Instantiates a new transacoes ECF aliquota search criteria.
	 */
	public TransacoesECFAliquotaSearchCriteria() {
	}
	 ...
	 */
	public TransacoesECFAliquotaSearchCriteria(final String codigoLoja, final LocalDate dataExtracao, final Integer paginaInicial, final Integer paginaFinal) {
