...
/**
 * The Class VendasSetorHoraSearchCriteria.
 */
public class VendasSetorHoraSearchCriteria implements Serializable {
	...
	/**
	 * Instantiates a new vendas setor hora search criteria.
	 */
	public VendasSetorHoraSearchCriteria() {
	}
	 ...
	 */
	public VendasSetorHoraSearchCriteria(final String codigoLoja, final LocalDateTime dataExtracao, final Integer paginaInicial, final Integer paginaFinal) {
	...
	/**
	 * Gets the left padding with zeros.
	 *
	 * @param time the time
	 * @return the hour left padding with zeros
	 */
	public String getLeftPaddingWithZeros(final LocalDateTime time) {
		return String.format("%02d", time.getHour() - 1);
	}
