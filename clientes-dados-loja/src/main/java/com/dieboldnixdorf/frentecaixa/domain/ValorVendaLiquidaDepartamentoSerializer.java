...
/**
 * The Class ValorVendaLiquidaDepartamentoSerializer.
 */
public class ValorVendaLiquidaDepartamentoSerializer extends JsonSerializer<BigDecimal> {

	/** The Constant CONTEXT. */
	public static final MathContext CONTEXT = new MathContext(17, RoundingMode.DOWN);
