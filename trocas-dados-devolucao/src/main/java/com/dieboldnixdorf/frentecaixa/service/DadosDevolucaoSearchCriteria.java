 ...
 */
public class DadosDevolucaoSearchCriteria implements Serializable {
	 ...
	 */
	public DadosDevolucaoSearchCriteria() {
	}
	 ...
	 */
	public DadosDevolucaoSearchCriteria(final String codigoLoja, final LocalDate dataExtracao, final Integer paginaInicial, final Integer paginaFinal) {
