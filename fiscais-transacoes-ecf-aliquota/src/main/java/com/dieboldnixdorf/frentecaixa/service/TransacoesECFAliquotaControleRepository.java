...
/**
 * The Interface TransacoesECFAliquotaControleRepository.
 */
interface TransacoesECFAliquotaControleRepository extends Repository<Ejtrailer, String> {
	 ...
	 */
	@Query(value = "SELECT date, totalvat, totalaos, totalmanualdisc, totalpoints, totalmkdn, seq from public.fnc_movtofiscalecfaliquota_ctrl(:dataExtracao, :codigoLoja) ",
        nativeQuery=true
    )
	@Cacheable("byTransacoesECFAliquotaControle")
