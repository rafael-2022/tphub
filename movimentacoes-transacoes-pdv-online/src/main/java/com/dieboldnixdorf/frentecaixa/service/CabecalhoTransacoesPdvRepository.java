...
interface CabecalhoTransacoesPdvRepository extends Repository<Ejheader1, Reg10PK> {
	 ...
	 * @return the list
	 */
	@Query(value = "SELECT storenmbr, mngrovnmbr, transnmbr, termnmbr, datahora, rectype, print1text, loyaltycardid, cshrnmbr, print2text, disc_empxnmbr, disc_custnmbr, :danfe as loyaltycardid2, drtoperador, naturezaoperacao, tipoemissao, codigopreorder, tiposaida, codigoparceiro, nomeparceiro, barcodepedido, tipopdv, 0 as pk from public.fnc_vendaonline_reg10(:date, :codigoLoja, :termnmbr, :transnmbr, :danfe, 0)", 
        nativeQuery=true)
