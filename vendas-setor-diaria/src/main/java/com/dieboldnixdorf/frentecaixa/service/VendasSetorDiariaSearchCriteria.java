 ...
 */
public class VendasSetorDiariaSearchCriteria implements Serializable {
	 ...
	 */
	public VendasSetorDiariaSearchCriteria() {
	}
	 ...
	 */
	public VendasSetorDiariaSearchCriteria(final String codigoLoja, final LocalDate dataExtracao, final Integer paginaInicial, final Integer paginaFinal) {
