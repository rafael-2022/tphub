...
/**
 * The Class DadosOperadoraLojaSearchCriteria.
 */
public class DadosOperadoraLojaSearchCriteria implements Serializable {
	...
	/**
	 * Instantiates a new dados operadora loja search criteria.
	 */
	public DadosOperadoraLojaSearchCriteria() {
	}
	 ...
	 */
	public DadosOperadoraLojaSearchCriteria(final String codigoLoja, final LocalDate dataExtracao, final Integer paginaInicial, final Integer paginaFinal) {
