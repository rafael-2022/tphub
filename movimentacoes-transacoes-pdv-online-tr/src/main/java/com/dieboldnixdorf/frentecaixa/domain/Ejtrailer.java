...
public class Ejtrailer {
	...
	@Basic
	@Column(name="valortrocodigital", columnDefinition="int8")
	private Long valorTrocoDigital;
	
	@Basic
	@Column(name="valortrocodoacao", columnDefinition="int8")
	private Long valorTrocoDoacao;

	@Basic
	@Column(name="pk", columnDefinition="int8")
	private Long pk;

	public Long getValorTrocoDigital() {
		return valorTrocoDigital;
	}

	public void setValorTrocoDigital(Long valorTrocoDigital) {
		this.valorTrocoDigital = valorTrocoDigital;
	}

	public Long getValorTrocoDoacao() {
		return valorTrocoDoacao;
	}

	public void setValorTrocoDoacao(Long valorTrocoDoacao) {
