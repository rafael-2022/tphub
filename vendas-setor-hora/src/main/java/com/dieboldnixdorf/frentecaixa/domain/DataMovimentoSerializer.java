...
public class DataMovimentoSerializer extends JsonSerializer<Calendar> {
	...
	public void serialize(final Calendar value, final JsonGenerator jgen, final SerializerProvider provider)
		...
		final LocalDateTime localDateTime =LocalDateTime.of(value.get(Calendar.YEAR),value.get(Calendar.MONTH) + 1, value.get(Calendar.DAY_OF_MONTH), value.get(Calendar.HOUR_OF_DAY), 0, 0);
