...
/**
 * The Interface VendasSetorDiariaControleRepository.
 */
interface VendasSetorDiariaControleRepository extends Repository<Ejtrailer, String> {
	 ...
	 */
	@Query(value = "SELECT date, totalvat, totalaos, totalmanualdisc, totalpoints, totalmkdn, seq from public.fnc_vendaporsetor_ctrl(:dataExtracao, :codigoLoja) ",
            nativeQuery=true
    )
	@Cacheable("byVendasSetorDiariaControle")
