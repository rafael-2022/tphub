...
/**
 * The Class MovimentacoesPdvBalcaoSearchCriteria.
 */
public class MovimentacoesPdvBalcaoSearchCriteria implements Serializable {
	...
	/**
	 * Instantiates a new movimentacoes pdv balcao search criteria.
	 */
	public MovimentacoesPdvBalcaoSearchCriteria() {
	}
	 ...
	 * @param numeroPDV the numero PDV
	 * @param numeroBalcao the numero balcao
	 */
	public MovimentacoesPdvBalcaoSearchCriteria(final String codigoLoja, final LocalDate dataExtracao, final Integer paginaInicial, final Integer paginaFinal) {
