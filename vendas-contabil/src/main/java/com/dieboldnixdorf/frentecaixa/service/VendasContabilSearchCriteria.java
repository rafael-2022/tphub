...
/**
 * The Class VendasContabilSearchCriteria.
 */
public class VendasContabilSearchCriteria implements Serializable {
	...
	/**
	 * Instantiates a new vendas contabil search criteria.
	 */
	public VendasContabilSearchCriteria() {
	}
	 ...
	 */
	public VendasContabilSearchCriteria(final String codigoLoja, final LocalDate dataExtracao, final Integer paginaInicial, final Integer paginaFinal) {
