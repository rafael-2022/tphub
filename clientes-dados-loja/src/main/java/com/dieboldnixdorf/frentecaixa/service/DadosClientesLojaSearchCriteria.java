...
/**
 * The Class DadosClientesLojaSearchCriteria.
 */
public class DadosClientesLojaSearchCriteria implements Serializable {
	...
	/**
	 * Instantiates a new dados clientes loja search criteria.
	 */
	public DadosClientesLojaSearchCriteria() {
	}
	 ...
	 */
	public DadosClientesLojaSearchCriteria(final String codigoLoja, final LocalDate dataExtracao, final Integer paginaInicial, final Integer paginaFinal) {
