...
/**
 * The Class MovimentacoesSangriaPdvSearchCriteria.
 */
public class MovimentacoesSangriaPdvSearchCriteria implements Serializable {
	...
	/**
	 * Instantiates a new movimentacoes sangria pdv search criteria.
	 */
	public MovimentacoesSangriaPdvSearchCriteria() {
	}
	 ...
	 */
	public MovimentacoesSangriaPdvSearchCriteria(final String codigoLoja, final LocalDate dataExtracao, final Integer paginaInicial, final Integer paginaFinal) {
