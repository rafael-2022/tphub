...
/**
 * The Class BigDecimal8Serializer.
 */
public class BigDecimal8Serializer extends JsonSerializer<BigDecimal> {

	/** The Constant CONTEXT. */
	public static final MathContext CONTEXT = new MathContext(8, RoundingMode.DOWN);
