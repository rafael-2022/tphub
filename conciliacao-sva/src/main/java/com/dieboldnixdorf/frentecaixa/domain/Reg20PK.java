...
public class Reg20PK implements Serializable {
     ...
     */
    @Basic
    @Column(name = "codprodgar")
    private Long codprodgar;
     ...
     */
    public void setCodprod(final Long codprod) {
     ...
     * @param codprod the new codprod
     */
    public void setCodprodgar(final Long codprodgar) {
        this.codprodgar = codprodgar;
    }
    ...
    public boolean equals(final Object obj) {
        if (obj instanceof Reg20PK) {
            ...
            return new EqualsBuilder()
                    .append(codprod, other.codprod)
                    .append(codprodgar, other.codprodgar)
