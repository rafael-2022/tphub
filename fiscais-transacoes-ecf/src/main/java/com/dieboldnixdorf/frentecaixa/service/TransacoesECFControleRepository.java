...
/**
 * The Interface TransacoesECFControleRepository.
 */
interface TransacoesECFControleRepository extends Repository<Ejtrailer, String> {
	 ...
	 */
	@Query(value = "SELECT date, totalvat, totalaos, totalmanualdisc, totalpoints, totalmkdn, seq from public.fnc_movtofiscalecf_ctrl(:dataExtracao, :codigoLoja) ",
        nativeQuery=true
    )
	@Cacheable("byTransacoesECFControle")
