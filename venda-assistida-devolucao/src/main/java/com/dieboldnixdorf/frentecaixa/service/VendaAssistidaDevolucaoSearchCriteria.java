 ...
 */
public class VendaAssistidaDevolucaoSearchCriteria implements Serializable {
	 ...
	 */
	public VendaAssistidaDevolucaoSearchCriteria() {
	}
	 ...
	 */
	public VendaAssistidaDevolucaoSearchCriteria(final String codigoLoja, final LocalDate dataExtracao, final Integer paginaInicial, final Integer paginaFinal) {
