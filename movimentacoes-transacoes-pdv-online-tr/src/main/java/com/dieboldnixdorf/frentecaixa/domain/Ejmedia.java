...
public class Ejmedia {
	...
	@Basic
	@Column(name="numeromatricula", columnDefinition="bpchar", length=20)
	private String numeroMatricula;
	
	@Basic
	@Column(name="codigonsusitef", columnDefinition="int8")
	private Long codigoNsuSitef;
	...
	public String toString() {
		return "Ejmedia [reg40PK=" + reg40PK + ", rectype=" + rectype + ", omediaamnt=" + omediaamnt + ", mdesc="
				+ mdesc + ", discountgrpident=" + discountgrpident + ", userlong=" + userlong + ", ordem=" + ordem
				+ ", bandeiraCartao=" + bandeiraCartao + ", codigoAutorizacao=" + codigoAutorizacao + ", doc=" + doc
				+ ", tipoVenda=" + tipoVenda + ", numeroCartao=" + numeroCartao + ", qtdeParcelas=" + qtdeParcelas
				+ ", pk=" + pk + ", numeroMatricula=" + numeroMatricula + ", codigoNsuSitef=" + codigoNsuSitef + "]";
	}
