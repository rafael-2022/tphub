...
interface RodapeTransacoesPdvRepository extends Repository<Ejtrailer, Reg50PK> {
	 ...
	 * @return the list
	 */
	@Query(value = " SELECT transnmbr, termnmbr, rectype, totalvat, totalaos, totalrounding, datahora_sod, datahora_eod, :danfe as loyaltycardid, 0 as pk  from public.fnc_vendaonline_reg50(:date, :codigoLoja, :termnmbr, :transnmbr, :danfe, 0) ", 
        nativeQuery=true)
