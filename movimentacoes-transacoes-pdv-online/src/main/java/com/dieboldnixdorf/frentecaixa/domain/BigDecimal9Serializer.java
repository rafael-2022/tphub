...
/**
 * The Class BigDecimal9Serializer.
 */
public class BigDecimal9Serializer extends JsonSerializer<BigDecimal> {

	/** The Constant CONTEXT. */
	public static final MathContext CONTEXT = new MathContext(9, RoundingMode.DOWN);
