...
/**
 * The Class DevolucaoContabilSearchCriteria.
 */
public class DevolucaoContabilSearchCriteria implements Serializable {
	...
	/**
	 * Instantiates a new devolucao contabil search criteria.
	 */
	public DevolucaoContabilSearchCriteria() {
	}
	 ...
	 */
	public DevolucaoContabilSearchCriteria(final String codigoLoja, final LocalDate dataExtracao, final Integer paginaInicial, final Integer paginaFinal) {
	...
	public Date getDataExtracao(final LocalDate pDdataExtracao) {
		...
		final DateTimeFormatter formatter = new DateTimeFormatterBuilder().appendPattern("dd/MM/yyyy").parseStrict().toFormatter();
