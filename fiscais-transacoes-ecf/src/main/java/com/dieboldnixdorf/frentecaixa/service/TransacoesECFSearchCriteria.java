...
/**
 * The Class TransacoesECFSearchCriteria.
 */
public class TransacoesECFSearchCriteria implements Serializable {
	...
	/**
	 * Instantiates a new transacoes ECF search criteria.
	 */
	public TransacoesECFSearchCriteria() {
	}
	 ...
	 */
	public TransacoesECFSearchCriteria(final String codigoLoja, final LocalDate dataExtracao, final Integer paginaInicial, final Integer paginaFinal) {
